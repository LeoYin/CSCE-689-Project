...
if __name__ == "__main__":
    ...
    parser.add_argument("--class_path", type=str, default="/home/lihao/LSTMFP/classes.txt", help="Path to frames")
    ...
    for epoch in range(opt.num_epochs):
        ...
        for batch_i, (Xf, Xp, y) in enumerate(train_dataloader):
            ...
            pose_sequences = Variable(Xp.to(device), requires_grad=True)
